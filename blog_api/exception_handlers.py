...
async def article_already_exists_exception_handler(request: Request, exc: ArticleAlreadyExists):
    return JSONResponse(
...
async def validation_error_exception_handler(request: Request, exc: ArticleValidationError):
    return JSONResponse(
